package guru.qas.martini.intellij.plugin.gherkin.psi.annotator;
...
import guru.qas.martini.intellij.plugin.gherkin.psi.GherkinPsiUtil;
...
public class GherkinAnnotatorVisitor extends GherkinElementVisitor {
	...
	public void visitStep(GherkinStep step) {
		...
		if (references.length != 1 || !(references[0] instanceof MartiniStepReference)) {
			return;
		}

		MartiniStepReference reference = (MartiniStepReference) references[0];
	...
	private void highlightOutlineParams(
		@NotNull final GherkinStep step,
		@NotNull final MartiniStepReference reference
	) {
	...
	private void highlightOutlineParamsForText(
		final String text, final int textStartInElementOffset, final Pattern pattern,
