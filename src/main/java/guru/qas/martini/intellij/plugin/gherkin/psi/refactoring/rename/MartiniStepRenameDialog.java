...
public class MartiniStepRenameDialog extends RenameDialog {
  private AbstractStepDefinition myStepDefinition;

  public MartiniStepRenameDialog(@NotNull Project project,
  ...
  protected String getFullName() {
    return MartiniBundle.message("martini.step");
  }
  ...
  private AbstractStepDefinition getStepDefinition() {
    if (myStepDefinition == null) {
      final MartiniStepReference ref = MartiniStepRenameProcessor.getCucumberStepReference(getPsiElement());
      if (ref != null) {
