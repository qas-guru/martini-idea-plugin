...
public abstract class NotIndexedMartiniExtension extends AbstractMartiniExtension {
  ...
  private void createWatcher(final PsiFile file) {
    ...
    final DataObject dataObject = (DataObject)MartiniStepsIndex.getInstance(file.getProject()).getExtensionDataObject(this);

    dataObject.myCucumberPsiTreeListener.addChangesWatcher(file, new MartiniPsiTreeListener.ChangesWatcher() {
  ...
  public List<AbstractStepDefinition> loadStepsForModule(@Nullable final PsiFile featureFile, @NotNull final Module module) {
    final DataObject dataObject = (DataObject)MartiniStepsIndex.getInstance(module.getProject()).getExtensionDataObject(this);
  ...
  public void reset(@NotNull final Project project) {
    final DataObject dataObject = (DataObject)MartiniStepsIndex.getInstance(project).getExtensionDataObject(this);
  ...
  public static class DataObject {
    ...
    final MartiniPsiTreeListener myCucumberPsiTreeListener = new MartiniPsiTreeListener();
  }
}
