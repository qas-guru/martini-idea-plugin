...
import guru.qas.martini.intellij.plugin.MartiniElementFactory;
...
public class GherkinElementFactory {
	...
	public static GherkinStepsHolder createScenarioFromText(
	...
	public static PsiElement[] getTopLevelElements(final Project project, @NotNull final String text) {
		return MartiniElementFactory.createTempPsiFile(project, text).getChildren();
	}
}
