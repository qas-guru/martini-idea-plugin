...
import guru.qas.martini.intellij.plugin.steps.search.MartiniStepSearchUtil;

public class MartiniUtil {
  ...
  public static boolean findPossibleGherkinElementUsages(@NotNull final PsiElement stepDefinitionElement,
    ...
    final SearchScope searchScope = MartiniStepSearchUtil.restrictScopeToGherkinFiles(() -> effectiveSearchScope);
    ...
    // PRC: final PsiSearchHelper instance = PsiSearchHelper.getInstance(project);
    PsiSearchHelper instance = ServiceManager.getService(project, PsiSearchHelper.class);
